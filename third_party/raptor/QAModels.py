...
# torch + transformers are intentionally NOT imported at module level.
# UnifiedQAModel (T5-based) is the only consumer; the pilot uses its
# own answerer shim that subclasses BaseQAModel, so importing this
# module should not require the heavy ML stack.
...
def _lazy_torch_imports():
    """Imported on first construction of UnifiedQAModel; not at module load."""
